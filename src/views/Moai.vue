...
const chickenImageModules = import.meta.glob('../assets/moai/**/*.{png,jpg,jpeg,webp,avif,gif}', {
  eager: true,
  import: 'default',
})
...
const saveStorageKey = 'barbequeChickenAlert.save.special.moai.v1'
...
<template>
  <div class="black-screen" style="touch-action: none; user-select: none;">
    ...
    <div class="hud">
      ...
      <div class="counter">Moais: {{ chickenCount }}</div>
    </div>
    ...
    <div v-if="isMenuOpen" class="menu-panel">
      ...
      >
        {{ nextUpgradeGain }} Moais per popup — Cost: {{ nextUpgradeCost }}
      </button>
      ...
      <div class="menu-bottom-section">
        ...
        <label class="menu-label" for="chicken-cap-input">Rendered moai cap</label>
        <input
