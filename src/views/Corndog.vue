...
const chickenImageModules = import.meta.glob('../assets/corndog/**/*.{png,jpg,jpeg,webp,avif,gif}', {
  eager: true,
  import: 'default',
})
...
const saveStorageKey = 'barbequeChickenAlert.save.special.corndog.v1'
...
onMounted(() => {
  ...
  document.title = 'Corndogcat Alert'
  updateViewport()
...
<template>
  <div class="black-screen" style="touch-action: none; user-select: none;">
    ...
    <div class="hud">
      ...
      <div class="counter">Corndogcats: {{ chickenCount }}</div>
    </div>
    ...
    <div v-if="isMenuOpen" class="menu-panel">
      ...
      >
        {{ nextUpgradeGain }} Corndogcat per popup — Cost: {{ nextUpgradeCost }}
      </button>
      ...
      <div class="menu-bottom-section">
        ...
        >
          Unlock ? — Cost: {{ chickenBreastUnlockCost }}
        </button>
        ...
        <label class="menu-label" for="chicken-cap-input">Rendered corndogcat cap</label>
        <input
